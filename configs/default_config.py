...
# this determines the size saveimages will be resized to, and the size of the labels created
IMAGE_WIDTH = 368
IMAGE_HEIGHT = 368
...
DATASET_SIZE = 38000  # exact size not critical
DATASET_VAL_SIZE = 23000

IMAGES_PER_TFRECORD = 1000

BATCH_SIZE =8 # for use when on cpu for development, if on GPU, can safely increase
